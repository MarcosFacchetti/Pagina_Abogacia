...
function Contacto() {
  return (
    <div className="text-center pb-[300px]">
      <h1 className="text-center text-white text-4xl mb-[3rem] border-b-[1px]">
        Contacto
      </h1>
      <p className="mb-4 text-white">Para consultas y más información, contácteme:</p>
      <div className="flex justify-center flex-col  md:flex-row sm:flex-col sm:space-y-[30px]">
        <a href="tel:+11234567890" className="flex flex-col mb-5 items-center mx-4 bg-gray-medium rounded-lg p-4 hover:bg-gray-800 cursor-pointer">
