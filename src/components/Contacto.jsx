...
function Contacto() {
  return (
    <div className="text-center pb-[300px]">
      ...
      <div className="flex justify-center md:flex-row sm:flex-col sm:space-y-[30px]">
        <a href="tel:+11234567890" className="flex flex-col items-center mx-4 bg-gray-medium rounded-lg p-4 hover:bg-gray-800 cursor-pointer">
